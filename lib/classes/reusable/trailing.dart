...
class ModdedTrailingHelper extends StatefulWidget {
  ModdedTrailingHelper({
    @required this.generate,
    @required this.loader,
    @required this.last,
  });
  ...
  @override
  _ModdedTrailingHelperState createState() => _ModdedTrailingHelperState();
}

class _ModdedTrailingHelperState extends State<TrailingHelper> {
  @override
  Widget build(BuildContext context) {
    return Stack(
      children: <Widget>[
